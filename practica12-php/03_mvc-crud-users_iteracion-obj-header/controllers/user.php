d<?php
    ...
    if($_GET){
        ...
        if($_GET['action'] == 'MODIFICAR_ESTADO'){
    ...
    class Usuarios{
            ...
            <form id="registro" class="form-control" method="POST" action="index.php" enctype="multipart/form-data">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <input name="email2" id="email2" type="mail" class="form-control" placeholder="Repetir email" required>
                    </li>
                    <li>
        ...
        private function setTable(){
            ...
            <table class="table table-striped table-dark table-hover">
                ...
                foreach($dtUsuarios as $dtUsuario){
                    ...
                    // Si es 1 es true, sale por la primera expresión
                    ...
                    $this->table.='<td>
                                        <span class="fa-solid fa-lightbulb" style="color:'.$color.'"></span>
                                   </td>';
                    $this->table.='<td>
        ...
        public function ModificarEstado($rowid){
            // llamada al modelo.
